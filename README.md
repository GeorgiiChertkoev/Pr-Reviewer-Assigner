...
* Использовать OpenAPI-спецификацию из `openapi.yaml`.
...
* Спроектировал реляционную модель данных с нормализацией сущностей
* Реализовал систему версионируемых SQL-миграций с помощью go-migrate
* Инициализация и обновление структуры автоматизированы в контейнерном окружении
* Операции создания PR, назначения и merge выполняются в транзакциях, обеспечивая атомарность и консистентность данных.
